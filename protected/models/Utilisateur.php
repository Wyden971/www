...
class Utilisateur extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('droit', 'numerical', 'integerOnly'=>true),
			array('login, pass, nom, prenom', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, login, pass, nom, prenom, droit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('droit',$this->droit);
